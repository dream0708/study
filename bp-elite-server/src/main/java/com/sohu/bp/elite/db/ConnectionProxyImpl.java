...
/**
 * create time: 2015年11月5日 下午4:26:43
 * @auther dexingyang
 */
public class ConnectionProxyImpl implements ConnectionProxy {  
     ...
     * 保存了真正的Connection 
     */  
    private final Map<String, Connection> conMap = new ConcurrentHashMap<String, Connection>();  
     ...
     * 自定义的数据源 
     */  
    private TransDataSourceWrapper cloudDataSourceWrapper;  
  
    public ConnectionProxyImpl(TransDataSourceWrapper cloudDataSourceWrapper)  
            throws SQLException {  
