 ...
 *
 */
public class AppStaticVCService extends ZookeeperContentService
{
	private static final Logger log = LoggerFactory.getLogger(AppStaticVCService.class);
	@Override
	public void excute(final String node,final boolean f){
    	...
    	try {
    		...
    		if(f){
	    		...
	    		OverallData.setAppStaticVerCode(contents);
    		}	
