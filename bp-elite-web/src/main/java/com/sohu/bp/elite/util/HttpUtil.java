...
//	            }
	...
	public static String auditAuthenPost(String uri, Map<String, String> params, String host) {
		String appKey = "bp";
		String appSec = "IMV6NUu1i2r5x2gL7PMQy9gkrh6ljhrK";
		return authenPost(uri, params, host, appKey, appSec);
	}

	public static String authenPost(String uri, Map<String, String> params, String host, String appKey, String appSec) {
		long time = System.currentTimeMillis();
		String method = "POST";
		Map<String, String> headers = new HashMap<>();
		headers.put("Timestamp", String.valueOf(time));
		headers.put("Auth", appKey + "|" + AuthenticationCenter.base64GenerateSignature(uri, method, time, appSec));
		return post(host + "/" + uri, params, headers);
	}
	
	public static void main(String args[]){
		String uri = "/audit/innerapi/elite-audit/reject";
		Map<String, String> params = new HashMap<>();
		String host="http://test.life.sohuno.com";
		System.out.println(auditAuthenPost(uri, params, host));
	}
}
